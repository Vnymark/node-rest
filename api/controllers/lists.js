...
// Fetches all lists
exports.lists_fetchAll = (req, res, next) => {
    List.find()
        .select('_id, name')
        .exec()
        .then(docs => {
...
// Creates a new list
exports.lists_create = (req, res, next) => {
    const list = new List({
...
exports.lists_fetchById = (req, res, next) => {
...
exports.lists_updateOne = (req, res, next) => {
    const updateOps = {};
...
exports.lists_delete = (req, res, next) => {
    List.findById(req.params.listId)
        .then(doc => {
            if (doc < 1) {
                res.status(404).json({
